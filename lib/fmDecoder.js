...
FmDecoder.prototype.setFrequency = function(freq) {
...
FmDecoder.prototype.write = function (data) {
  ...
  var writeIdx = 0;
  for (var readIdx = 0; readIdx < this.fm.signalLen; readIdx += 2) {
    var v = this.fm.signal2[readIdx];
    this.fm.emitData[writeIdx++] = v >> 8;
    this.fm.emitData[writeIdx++] = v >> 0;
  }
